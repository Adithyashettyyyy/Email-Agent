...
function formatSmtpError(error: unknown): string {
  ...
  if (message.includes("535") || message.includes("BadCredentials")) {
    return "Gmail rejected the login. Generate a new App Password for zenocyber2@gmail.com (with 2-Step Verification on), update SMTP_PASSWORD in .env, and restart the server.";
  }
